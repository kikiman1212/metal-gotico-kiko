...
exampleModal.addEventListener('show.bs.modal', function (event) {
  ...
  modalTitle.textContent = 'Nostra Morte' + recipient
...
document.getElementById('ventana2').addEventListener('click', function() {
  ...
  document.body.style.backgroundImage = "url('https://cuarteldelmetal.com/wp-content/uploads/2022/07/Nostra-Morte-concierto-Lima-Peru-.jpg')";
});
...
document.getElementById('cerrar2').addEventListener('click', function() {
  ...
  alert('Adios de Nostra Morte ' + texto);
  document.querySelector('.container').style.display = 'block';
  document.body.style.backgroundImage = "url('https://upload.wikimedia.org/wikipedia/commons/c/c3/Therion_in_Paris_2007_-_full_lineup.jpg')";
});
